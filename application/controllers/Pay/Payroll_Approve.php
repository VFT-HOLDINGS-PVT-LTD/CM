...
class Payroll_Approve extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $currentMonth = date('m');
        // date('M');
        $data['data_set'] = $this->Db_model->getfilteredData("SELECT * FROM tbl_salary_edited INNER JOIN tbl_empmaster ON tbl_salary_edited.EmpNo = tbl_empmaster.EmpNo WHERE tbl_empmaster.EmpNo != '00009000' AND tbl_salary_edited.Edited = '1'");
    ...
    public function reject_data()
    {
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
            ...
            $sal_id =  $edit_salary[0]->Salary_t_id;
            // echo $sal_id;
