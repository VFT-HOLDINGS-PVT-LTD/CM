...
//        $data['t_date'] = $to_date;
        ...
        if (($this->input->post("cmb_month")) && ($this->input->post("cmb_year"))) {
            if ($filter == '') {
                $filter = "where tbl_salary.Month = '$Month' and tbl_salary.Year = '$year' AND tbl_empmaster.Status = '1' AND tbl_empmaster.EmpNo != '9000' ";
            } else {
                $filter .= " AND  tbl_salary.Month = '$Month' and tbl_salary.Year = '$year' AND tbl_empmaster.Status = '1' AND tbl_empmaster.EmpNo != '9000' ";
            }
        }
