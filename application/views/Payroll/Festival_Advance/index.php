    ...
    <div id="wrapper">
                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="index.html">FESTIVAL ADVANCE</a></li>
                        ...
                        <div class="page-tabs">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a data-toggle="tab" href="#tab1">ESTIVAL ADVANCE</a></li>
                                <li><a data-toggle="tab" href="#tab2">VIEW ESTIVAL ADVANCE</a></li>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-info">
                                                        <div class="panel-heading">
                                                            <h2>ADD ESTIVAL ADVANCE</h2>
                                                        </div>
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_loan_entry" name="frm_loan_entry" action="<?php echo base_url(); ?>Pay/Festival_Advance/insert_data" method="POST">
                                                                ...
                                                                <div class="form-group col-sm-12">
                                                                    <div class="col-sm-8">
                                                                        <img style="margin-left: 30%; width: 120px; height: 100px;" src="<?php echo base_url(); ?>assets/images/salary_advance.png">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    <label for="focusedinput" class="col-sm-4 control-label">Festival Advance Type</label>
                                                                    <div class="col-sm-8">
                                                                        <select class="form-control" required="required" id="cmb_loan_id" name="cmb_loan_id">
                                                                            ...
                                                                            <?php foreach ($data_loan as $t_data) { ?>
                                                                                <option value="<?php echo $t_data->Fest_ID; ?>"><?php echo $t_data->Festival_Name; ?></option>
                                                                ...
                                                                <div class="form-group col-sm-6">
                                                                    <label for="focusedinput" class="col-sm-4 control-label">Festival Advance Amount</label>
                                                                    <div class="col-sm-8">
        ...
        <script>
            ...
            $("#search").click(function() {
                ...
                $('#search_body').load("<?php echo base_url(); ?>Pay/Festival_Advance/getLoans", {
                    'txt_emp': $('#txt_emp').val(),
