                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>Master/Allowance_Types/">ALLOWANCES</a></li>
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal" action="<?php echo base_url(); ?>Master/Allowance_Types/edit" method="post">
                                                    <div class="form-group col-sm-12">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input value="" type="text" class="form-control" readonly="readonly" name="id" id="Alw_ID" class="m-wrap span3">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input value="" type="text" name="Allowance_Name" id="L_Name" class="form-control m-wrap span6"><br>
                                                        </div>
                                                    </div>
                ...
                $(".get_data").click(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            // console.log(response[0].Alw_ID);

                            $('#Alw_ID').val(response[0].Alw_ID);
                            $('#L_Name').val(response[0].Allowance_name);
