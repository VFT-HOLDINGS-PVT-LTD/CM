                ...
                <div class="static-content">
                    <div class="page-content">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="">ETF REPORT</a></li>
                                            ...
                                            <div class="panel panel-primary">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form class="form-horizontal" id="frm_in_out_rpt"
                                                        name="frm_in_out_rpt"
                                                        action="<?php echo base_url(); ?>Reports/Payroll/ETF_Report/ETF_Report_Report_By_Cat"
                                                        method="POST">

                                                        <div>
                                                            <label style="font-weight: bold; color: #000"> ETF
                                                        ...
                                                        <div class="form-group col-sm-12" style="margin-top: 2vh;">
                                                            <div class="col-sm-6">
                                                                <img class="imagecss"
                                                                    src="<?php echo base_url(); ?>assets/images/salary_advance_reg.png">
                                                            </div>
