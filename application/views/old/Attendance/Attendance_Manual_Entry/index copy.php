    ...
    <div id="wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-tabs">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a data-toggle="tab" href="#tab1">MANUAL ATTENDANCE</a></li>
                                <li class="active"><a data-toggle="tab" href="#tab_upload">MANUAL ATTENDANCE UPLOAD</a></li>
                                                    ...
                                                    <div class="panel panel-info">
                                                        ...
                                                        <div class="panel-body">
                                                            <form class="form-horizontal" id="frm_employee_view"
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <div class="form-group col-sm-6">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <input type="text" class="form-control" required="" id="att_date_1" name="txt_to_date" placeholder="Select Date">
                                                                    ...
                                                                    <div class="form-group col-sm-6" style="">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            ...
                                                                            <input type="text" class="form-control" required="" id="to_date" name="txt_to_date" placeholder="Select Date">
                                                                ...
                                                                <button type="submit" class="btn btn-succes">Download Format</button>
                                                                <!--submit button-->
                                                            ...
                                                            <div class="upload-container">
                                                                ...
                                                                <form action="<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry/upload_sample" method="POST" enctype="multipart/form-data">
                                                                    <div class="mb-3">
                                                                        <label for="file" class="form-label">Select Excel File (.xlsx)</label>
                                                                        <input type="file" class="form-control" name="upload_excel" id="upload_excel" accept=".xlsx" required>
                                                                    </div>
        ...
        <script>
            ...
            $("#search").click(function() {
                ...
                $('#search_body').load("<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry/search_employee", {
                    'txt_emp': $('#txt_emp').val(),
