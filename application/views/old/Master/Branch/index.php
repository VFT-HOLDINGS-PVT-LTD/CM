                                                            ...
                                                            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    <?php foreach ($data_array as $data): ?>
                                                                        <tr class="odd gradeX">
                                                                            <td width="100"><?= $data->B_id ?></td>
                                                                            <td width="100"><?= $data->B_name ?></td>
                                                                            <td width="100"><?= $data->Address ?></td>
                                                                            <td width="100"><?= $data->Tel1 ?></td>
                                                                            <td width="100"><?= $data->Tel2 ?></td>
                                                                            <td width="100"><?= $data->Fax ?></td>
                                                                            ...
                                                                            <td width="15">
                                                                                <a class="get_data btn btn-green"
                                                                                    ...
                                                                                    data-target="#myModal"
                                                                                    data-id="<?= $data->B_id ?>"
                                                                                    href="<?= base_url('index.php/Master/Branch/branch_details' . $data->B_id) ?>">
                                                                                    <i class="fa fa-edit"></i>
                                                                                </a>
                                                                            </td>

                                                                            <td width="15">
                                                                                <a class="action_comp btn btn-danger" href="javascript:void(0);" title="DELETE" onclick="confirmDelete('<?= $data->B_id ?>')">
