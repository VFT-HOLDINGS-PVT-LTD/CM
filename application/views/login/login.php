                                    ...
                                    <div class="col-lg-11 col-md-12">
                                        <div class="card-body text-center">
                                            ...
                                            <a href="../main/index.html" class="text-nowrap logo-img d-block mb-4 w-100">
                                                <img src="<?php echo !empty($logo[0]->comp_logo) ? base_url() . $logo[0]->comp_logo : base_url() . 'assets/images/company.png'; ?>" class="dark-logo" alt="Logo-Dark" style="width: 190px; border-radius: 10px;" />
                                            </a>
                                            ...
                                            <form class="form-horizontal" id="frmLogin" name="frmLogin" action="<?php echo base_url() ?>login/verifyUser" method="POST">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center">
                                                    <p class="fs-12 mb-0 fw-medium">VFT PAYROLL SYSTEM V1.1</p>
                                                </div>
