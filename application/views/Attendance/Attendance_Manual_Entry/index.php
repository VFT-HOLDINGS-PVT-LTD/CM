    ...
    <div id="wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-tabs">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a data-toggle="tab" href="#tab_upload">MANUAL ATTENDANCE UPLOAD</a>
                                </li>
                                                    ...
                                                    <div class="panel panel-info">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="upload-container">
                                                                ...
                                                                <form id="uploadForm" enctype="multipart/form-data" style="margin-left: 10px;">
                                                                    <div class="upload-container">
        ...
        <script>
            document.getElementById("uploadForm").addEventListener("submit", async function (event) {
                ...
                try {
                    const response = await fetch("<?php echo base_url(); ?>Attendance/Attendance_Manual_Entry/upload_sample", {
                        method: "POST",
                        body: formData
                    });
                    ...
                    messageBox.innerHTML = "<span style='color: red;'>❌ Upload failed. Please try again.</span>";
                } finally {
